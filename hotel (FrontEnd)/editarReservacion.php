        ...
        <div id="layoutSidenav_content">
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">Error al actualizar</h4>
                                <button type="button" class="close" data-dismiss="modal">&times;</button>

                            </div>
                            <div class="modal-body">
                                <p>
                                    <?php $reasons = array("error" => "No se pudo actualizar la reservacion en el sistema", 
            ...
            <main>
                <div class="container-fluid">
                    ...
                    <form class="validate-form needs-validation" novalidate action="functions/actualizarReservacion.php?reservacion=<?php echo $_GET['reservacion'] ?>""
                        method="POST">
                        <div class="form-row">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control py-4" id="numAdultos" name="numAdultos" type="number"
                                         min="1" max="8" value="<?php echo $respuesta->{'numAdultos'}?>" placeholder="Ingresa numero de adultos"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control py-4" id="numNinos" name="numNinos" type="number" 
                                         min="0" max="3" value="<?php echo $respuesta->{'numNinos'}?>" placeholder="Ingresa el numero de niños"
                                        required />
                                </div>
                            </div>
