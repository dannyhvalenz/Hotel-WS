        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <form class="validate-form needs-validation" novalidate action="functions/registrarCliente.php" method="POST">
                        <div class="form-row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control py-4" id="correo" name="correo" type="email" aria-describedby="emailHelp"
